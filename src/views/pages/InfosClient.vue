                            ...
                            <v-row>
                                <v-col cols="12">
                                    <div class="text-center">
                                        ...
                                        <v-row>
                                            <v-col cols="12" md="6">
                                                <v-text-field color="indigo" label="Nom*" v-model="client.lastname" prepend-inner-icon="mdi-alphabetical" clearable :rules="rules.caractereRules" required solo />
                                            </v-col>
                                            <v-col cols="12" md="6">
                                                <v-text-field color="indigo" label="Prénom*" v-model="client.firstname" prepend-inner-icon="mdi-alphabetical" clearable :rules="rules.caractereRules" required solo />
                                            </v-col>
                                        </v-row>
                                        <v-row class="mt-n4">
                                            <v-col cols="12" md="6">
