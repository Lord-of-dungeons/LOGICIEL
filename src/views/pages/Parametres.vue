                        ...
                        <v-card class="pa-2" height="auto" outlined color="transparent">
                            <v-col cols="12">
                                <v-form ref="formUser" v-model="rules.valid" lazy-validation class="text-center">
                                    <v-row>
                                        <v-col cols="12" md="6">
                                            <v-text-field color="purple" label="Nom" v-model="user.lastname" prepend-inner-icon="mdi-alphabetical" :clearable="isUpdateUser" :disabled="!isUpdateUser" :rules="rules.caractereRules" required />
                                        </v-col>
                                        <v-col cols="12" md="6">
                                            <v-text-field color="purple" label="Prénom" v-model="user.firstname" prepend-inner-icon="mdi-alphabetical" :clearable="isUpdateUser" :disabled="!isUpdateUser" :rules="rules.caractereRules" required />
                                        </v-col>
                                    </v-row>
                                    <v-row class="mt-n4">
                                        <v-col cols="12" md="12">
