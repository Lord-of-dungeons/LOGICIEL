                            ...
                            <v-container fluid>
                                <v-row dense justify="center" align="center" align-content="center">
                                    <v-col align-self="start" order="auto" cols="12" md="6">
                                        ...
                                        <v-text-field clearable v-model="contact.lastname" label="Nom*" prepend-icon="mdi-alphabetical" :rules="rules.caractereRules" required />
                                    </v-col>
                                    <v-col align-self="start" order="auto" cols="12" md="6">
                                        <v-text-field clearable v-model="contact.firstname" label="Prénom*" prepend-icon="mdi-alphabetical" :rules="rules.caractereRules" required />
                                    </v-col>
