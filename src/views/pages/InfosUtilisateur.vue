                            ...
                            <v-row>
                                <v-col cols="12">
                                    <div class="text-center">
                                        ...
                                        <v-row>
                                            <v-col cols="12" md="6">
                                                <v-text-field color="info" label="Nom*" v-model="user.lastname" prepend-inner-icon="mdi-alphabetical" clearable :rules="rules.caractereRules" required solo />
                                            </v-col>
                                            <v-col cols="12" md="6">
                                                <v-text-field color="info" label="Prénom*" v-model="user.firstname" prepend-inner-icon="mdi-alphabetical" clearable :rules="rules.caractereRules" required solo />
                                            </v-col>
                                        </v-row>
                                        <v-row class="mt-n4">
                                            <v-col cols="12" md="6">
